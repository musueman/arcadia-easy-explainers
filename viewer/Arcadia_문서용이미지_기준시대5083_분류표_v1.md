...
| 우선순위 | 이미지 ID | 상태 | 연결 단락 | 제안 파일명 | 핵심 내용 |
|---:|---|---|---|---|---|
| 1 | IMG-CK5083-PLC-001 | 문서 병합 완료 | 기준시대 5083 객관정보 4장 | `assets/images/ck5083-cities-places-function-network-v1.svg` | 중심권, 북방·외연권, 남방·주변권, 레이븐스톤 하위 장소를 권력·기록·물류·생존 기능망으로 묶어 보여주는 도시·장소 도식 |
| 2 | IMG-ILL-CK5083-PLC-001 | 도식 확정 후 대기 | 기준시대 5083 객관정보 4장 | `assets/illustrations/ck5083-cities-places-life-surfaces-v1.png` | 4장 장소 기능망을 바탕으로 궁정, 군항, 성문, 창고, 수문, 기록원, 산악 수도원, 강하 항구의 생활 표면을 보여주는 설정화 |
...
| IMG-CK5083-PLC-001 | `assets/images/ck5083-cities-places-function-network-v1.svg` | 통과·병합 | 기준시대 5083 객관정보 4장 도시·장소 백과 아래에 도시·장소 기능망 도식을 병합했다. |
...
| 도시·장소 기능망 도식 | 4장 장소 표 앞에 삽입 |
| 도시·장소 설정화 | 4장 장소 표 앞, 도식 직후에 삽입 |
